    ...
    pub fn to_router_config(&self) -> config::ConfigResult<config::RouterConfig> {
        ...
        let convert_policy = |policy: &PolicyType| -> ConfigPolicyConfig {
            match policy {
                ...
                PolicyType::ChunkAware => ConfigPolicyConfig::ChunkAware {
                    chunk_size_tokens: self.chunk_aware_chunk_size_tokens,
                    long_prefill_threshold_tokens: self
                        .chunk_aware_long_prefill_threshold_tokens,
...
impl Router {
    ...
    #[pyo3(signature = (
        ...
        chunk_aware_chunk_size_tokens = 8192,
        chunk_aware_long_prefill_threshold_tokens = 8192,
        chunk_aware_load_weight = 1.5,
        chunk_aware_prefill_work_weight = 1.0,
        chunk_aware_prefix_affinity_credit = 0.2,
        chunk_aware_min_cache_match_rate = 0.3,
        chunk_aware_spillover_bound_chunks = 4.0,
        chunk_aware_load_check_interval_secs = 1,
        chunk_aware_chars_per_token = 4.0,
    ...
    fn new(
        ...
        Ok(Router {
            ...
            max_idle_secs,
            assignment_mode,
            chunk_aware_chunk_size_tokens,
            chunk_aware_long_prefill_threshold_tokens,
            chunk_aware_load_weight,
            chunk_aware_prefill_work_weight,
            chunk_aware_prefix_affinity_credit,
            chunk_aware_min_cache_match_rate,
            chunk_aware_spillover_bound_chunks,
            chunk_aware_load_check_interval_secs,
            chunk_aware_chars_per_token,
            max_payload_size,
            dp_aware,
            api_key,
            log_dir,
